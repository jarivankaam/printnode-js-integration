<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="title" style="display:flex; justify-content: center;">
            <h2><a href="#" style="color:white;">PrintNode JS POC</a></h2>
         </div>       
        <div class="forms" style="display:flex; justify-content:center;">
            <div class="formsContainer" style=" display:flex; justify-content:center;">
                <form action="#">
                    <select class="id" id="id" name="id">


                    </select>
                    <br>
                    <input style="width:100%;" type="text" id="title" name="title" placeholder="titel">
                    <br>
                    <input style="width:100%; display:none;"  type="text" name="url" id="url" placeholder="url naar bestand">
                </form>
                <button onclick="printJobQue()">print</button>
            </div>
        </div>        
